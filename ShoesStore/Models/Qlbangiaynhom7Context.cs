...
public partial class Qlbangiaynhom7Context : DbContext
{
    public Qlbangiaynhom7Context()
    {
    }

    public Qlbangiaynhom7Context(DbContextOptions<Qlbangiaynhom7Context> options)
        : base(options)
    {
    }
